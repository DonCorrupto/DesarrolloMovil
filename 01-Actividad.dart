...
void main(List<String> args) {
  ...
  while (input != "0") {
    ...
    var listTemporal = [];
    if (input == "1") {
      print("Ingrese el sexo del paciente. M - Hombre o F - Mujer");
      var sexo = stdin.readLineSync().toString();
      print(
          "Ingrese el estado civil del paciente, S - Soltero, C - Casado, V - Viudo");
      var estadoCivil = stdin.readLineSync().toString();
